...
public class TestDamUtils2 extends BaseAbstractTest{
	 ...
	 */
	@Test
	public void testGetAltText2Null(){
	 ...
	 */
	@Test
	public void testGetAltText2NotNull(){
		...
		Assert.assertEquals("feature-component", DamUtils2.getAltText2("/content/dam/rmit/feature-component-1-up.jpg",resourceResolver));
	}
	 ...
	 */
	@Test
	public void testGetAltTextImage2Null(){
		Mockito.when(resourceResolver.getResource(Mockito.anyString())).thenReturn(mockResource);
		Mockito.when(mockResource.adaptTo(ValueMap.class)).thenReturn(valueMap);
		String dcTitle = DamUtils2.getAltText2("/content/dam/rmit/feature-component-1-up.jpg",resourceResolver);
	 ...
	 */
	@Test
	public void testGetImageTitle2Null(){
		Assert.assertNull(DamUtils2.getImageTitle2("/content/dam/rmit/feature-component-1-up.jpg",resourceResolver));
	}
	 ...
	 */
	@Test
	public void testGetImageTitle2NotNull(){
		Mockito.when(resourceResolver.getResource(Mockito.anyString())).thenReturn(mockResource);
		Mockito.when(mockResource.adaptTo(Asset.class)).thenReturn(asset);
		Mockito.when(asset.getName()).thenReturn("feature-component");
		Assert.assertEquals("feature-component",DamUtils2.getImageTitle2("/content/dam/rmit/feature-component-1-up.jpg",resourceResolver));
	}
