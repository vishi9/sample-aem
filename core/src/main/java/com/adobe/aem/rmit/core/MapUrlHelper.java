...
public class MapUrlHelper extends WCMUsePojo {
	...
	public static String getMapURL(SlingHttpServletRequest slingRequest, String url) {
	...
	public static String appendHtml(String mappedUrl) {
		if (mappedUrl == null)
			return null;
