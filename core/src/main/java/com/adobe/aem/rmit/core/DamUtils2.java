...
public class DamUtils2 {
	...
	public static String getAltText2(String imagePath, ResourceResolver resourceResolver) {
	...
	public static String getImageTitle2(String imagePath, ResourceResolver resourceResolver) {
